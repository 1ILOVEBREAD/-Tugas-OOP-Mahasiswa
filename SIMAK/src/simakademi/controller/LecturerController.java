...
import simakademi.dao.LecturerDAO;
...
public class LecturerController {
    ...
    private void validasiInput(String nidn, String nama, String keahlian, String noHp) throws Exception {
        ...
        if (!nidn.trim().matches("\\d{10}")) throw new Exception("NIDN harus tepat 10 digit angka!");
        if (!noHp.trim().matches("\\d{10,13}")) throw new Exception("No. HP harus 10-13 digit angka!");
    }
}
